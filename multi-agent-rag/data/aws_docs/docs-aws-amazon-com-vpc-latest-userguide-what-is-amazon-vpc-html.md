...
**Transit gateways**Use a transit gateway, which acts as a central hub, to route traffic between your VPCs, VPN connections, and Direct Connect connections.

**VPC Flow Logs**A flow log captures information about the IP traffic going to and from network interfaces in your VPC.

**VPN connections**Connect your VPCs to your on-premises networks using AWS Virtual Private Network (Site-to-Site VPN).
...
If you are an existing or new AWS Free Tier*Public IPv4 address* tab in Amazon VPC Pricing
