...
<!-- 출처: https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-spot-instances.html -->
...
-
*Spot capacity pool*– A set of unused EC2 instances with the same instance type (for example,`m5.large`
